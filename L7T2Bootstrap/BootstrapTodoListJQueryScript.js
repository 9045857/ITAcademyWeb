$(document).ready(function () {
    ...
    function getNewTaskTr() {
        return $("<li class= 'd-flex bd-highlight'>" +
            ...
            "<button class='btn btn-outline-secondary btn-light display-none' type='button'><i class='fas fa-remove-format'></i></button>" +
            "<button class='btn btn-outline-secondary btn-light display-none' type='button'><i class='fas fa-save'></i></button>" +
            "<button class='btn btn-outline-secondary btn-light' type='button'><i class='far fa-edit'></i></button>" +
            "<button class='btn btn-outline-secondary btn-light' type='button'><i class='fas fa-trash-alt'></i></button>" +
            "</div>" +
            "</div>" +
            "</li>"
        );
